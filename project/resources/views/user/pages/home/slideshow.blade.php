<div class="slideshow-section position-relative">
    <div class="slideshow-active activate-slider"
        ...
        <div class="slide-item slide-item-bag position-relative">
            <img class="slide-img d-none d-md-block" src="{{ asset('themes/user') }}/img/slideshow/f1.jpg"
                alt="slide-1">
            <img class="slide-img d-md-none" src="{{ asset('themes/user') }}/img/slideshow/f1-m.jpg"
                alt="slide-1">
        ...
        <div class="slide-item slide-item-bag position-relative">
            <img class="slide-img d-none d-md-block" src="{{ asset('themes/user') }}/img/slideshow/f2.jpg"
                alt="slide-2">
            <img class="slide-img d-md-none" src="{{ asset('themes/user') }}/img/slideshow/f2-m.jpg"
                alt="slide-2">
            <div class="content-absolute content-slide">
                <div class="container height-inherit d-flex align-items-center justify-content-end">
        ...
        <div class="slide-item slide-item-bag position-relative">
            <img class="slide-img d-none d-md-block" src="{{ asset('themes/user') }}/img/slideshow/f3.jpg"
                alt="slide-3">
            <img class="slide-img d-md-none" src="{{ asset('themes/user') }}/img/slideshow/f3-m.jpg"
                alt="slide-3">
            <div class="content-absolute content-slide">
