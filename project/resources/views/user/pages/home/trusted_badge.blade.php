        ...
        <div class="container">
            <div class="row justify-content-center trusted-row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="trusted-badge rounded p-0">
                        <div class="trusted-icon">
                            <img class="icon-trusted" src="{{ asset('themes/user') }}/img/trusted/1.png"
                                alt="icon-1">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="trusted-badge rounded p-0">
                        <div class="trusted-icon">
                            <img class="icon-trusted" src="{{ asset('themes/user') }}/img/trusted/2.png"
                                alt="icon-2">
                        </div>
                        <div class="trusted-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="trusted-badge rounded p-0">
                        <div class="trusted-icon">
                            <img class="icon-trusted" src="{{ asset('themes/user') }}/img/trusted/3.png"
                                alt="icon-3">
                        </div>
                        <div class="trusted-content">
