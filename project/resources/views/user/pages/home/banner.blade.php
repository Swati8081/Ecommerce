        ...
        <div class="container">
            <div class="grid-container-2">
                <a class="grid-item grid-item-1 position-relative rounded mt-0 d-flex"
                    ...
                    <img class="banner-img rounded" src="{{ asset('themes/user') }}/img/banner/f1.jpg"
                        alt="banner-1">
                ...
                <a class="grid-item grid-item-2 position-relative rounded mt-0 d-flex"
                    href="collection-left-sidebar.html" data-aos="fade-right" data-aos-duration="700">
                    <img class="banner-img rounded" src="{{ asset('themes/user') }}/img/banner/f3.jpg"
                        alt="banner-1">
                    <div class="content-absolute content-slide">
                ...
                <a class="grid-item grid-item-3 position-relative rounded mt-0 d-flex"
                    ...
                    <img class="banner-img rounded" src="{{ asset('themes/user') }}/img/banner/f2.jpg"
                        alt="banner-1">
                    <div class="content-absolute content-slide">
                        <div class="container height-inherit d-flex">
                            <div class="content-box banner-content p-4">
