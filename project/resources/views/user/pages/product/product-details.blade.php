                          ...
                          <div class="product-gallery product-gallery-vertical d-flex">
                              <div class="product-img-large">
                                  <div class="img-large-slider common-slider"
                                      data-slick='{ "slidesToShow": 1, "slidesToScroll": 1, "dots": false, "arrows": false, "asNavFor": ".img-thumb-slider" }'>
                                      
                                      @foreach  ($product->images as $image)

                                      <div class="img-large-wrapper">
                                        <a href="{{ asset($image->large_img) }}" data-fancybox="gallery">
                                            <img src="{{ asset($image->large_img) }}" alt="img">
                                        </a>
                                    </div>
                                      @endforeach
                                  </div>
                              ...
                              <div class="product-img-thumb">
                                  <div class="img-thumb-slider common-slider" data-vertical-slider="true"
                                      data-slick='{ "slidesToShow": 5, "slidesToScroll": 1, "dots": false, "arrows": true, "infinite": false, "speed": 300, "cssEase": "ease", "focusOnSelect": true, "swipeToSlide": true, "asNavFor": ".img-large-slider" }'>
                                      @foreach ($product->images as $image)
                                      <div>
                                        <div class="img-thumb-wrapper">
                                            <img src="{{ asset($image->small_img ?? '') }}" alt="img">
                                        </div>
                                    </div> 
                                      @endforeach
                                  </div>
                      ...
                      <div class="col-lg-6 col-md-12 col-12">
                          <div class="product-details ps-lg-4">
                              ...
                              <div class="product-price-wrapper mb-4">
                                  <span class="product-price regular-price">{{ $product->mrp }}</span>
                                  <del class="product-price compare-price ms-2">{{ $product->sale_price }}</del>
                              </div>
                              <div class="product-sku product-meta mb-1">
                                  <strong class="label">SKU:</strong> {{ $product->SKU }}
                              </div>
                              ...
                              <form class="product-form" action="{{ route('cart.add') }}" method="post">
                                  @csrf
                  ...
                  <div class="tab-list product-tab-list">
                      <nav class="nav product-tab-nav">
                          ...
                          <a class="product-tab-link tab-link" href="#pshipping" data-bs-toggle="tab">Shipping &
                              Returns</a>
                          <a class="product-tab-link tab-link" href="#pstyle" data-bs-toggle="tab">Short Description</a>
                  ...
                  <div class="tab-content product-tab-content">
                      ...
                      <div id="pshipping" class="tab-pane fade">
                          <div class="desc-content">
                              ...
                              <p class="text_16 mb-4">The European law states that when an order is being returned, it
