                            ...
                            <div class="login-form style-2">
                                ...
                                <div class="card-body">
                                    <div class="logo-header">
                                        <a href="{{asset('themes/admin')}}/index.html" class="logo"><img src="{{asset('themes/admin')}}/images/logo/logo-full.png" alt="" class="width-230 light-logo"></a>
                                        <a href="{{asset('themes/admin')}}/index.html" class="logo"><img src="{{asset('themes/admin')}}/images/logo/logofull-white.png" alt="" class="width-230 dark-logo"></a>
                                    </div>
                                      ...
                                      <div class="tab-pane fade" id="nav-sign" role="tabpanel" aria-labelledby="nav-sign-tab">
                                        <form class="dz-form py-2">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <label ><a href="{{asset('themes/admin')}}/#">Terms of Service </a>&amp; <a href="{{asset('themes/admin')}}/#">Privacy Policy</a></label>
                                            </div>
                                            <div class="form-group clearfix text-left">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="col-lg-12 text-center">
                                            ...
                                            <a href="{{asset('themes/admin')}}/javascript:void(0);">DexignZone </a> All rights reserved.</span> 
                                        </div>
                                    </div>
                                </div>	
