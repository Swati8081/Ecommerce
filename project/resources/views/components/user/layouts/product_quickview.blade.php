                            ...
                            <div class="product-img-large">
                                <div class="qv-large-slider img-large-slider common-slider" data-slick='{
                                    ...
                                    <div class="img-large-wrapper">
                                        <img src="{{asset('themes/user')}}/img/products/bags/39.jpg" alt="img">
                                    </div>
                                    <div class="img-large-wrapper">
                                        <img src="{{asset('themes/user')}}/img/products/bags/38.jpg" alt="img">
                                    </div>
                                    <div class="img-large-wrapper">
                                        <img src="{{asset('themes/user')}}/img/products/bags/37.jpg" alt="img">
                                    </div>
                                    <div class="img-large-wrapper">
                                        <img src="{{asset('themes/user')}}/img/products/bags/36.jpg" alt="img">
                                    </div>
                                    <div class="img-large-wrapper">
                                        <img src="{{asset('themes/user')}}/img/products/bags/34.jpg" alt="img">
                                    </div>
                                    <div class="img-large-wrapper">
                                        <img src="{{asset('themes/user')}}/img/products/bags/30.jpg" alt="img">
                                    </div>
                                    <div class="img-large-wrapper">
                                        <img src="{{asset('themes/user')}}/img/products/bags/32.jpg" alt="img">
                                    </div>
                                </div>
                            </div>
